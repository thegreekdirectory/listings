...
These Unsplash images are automatically used when listings don't have custom logos/photos.
...
Images are automatically applied by the admin portal when:
- No logo is uploaded → Uses logo URL (200x200 crop)
- No photos are uploaded → Uses main URL (800x600)
