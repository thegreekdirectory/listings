                        ...
                        <div class="p-4">
                            <div class="flex gap-3 mb-3">
                                ...
                                <div class="flex-1 min-w-0">
                                    ...
                                    <h3 class="text-lg font-bold text-gray-900 flex items-center gap-1.5 min-w-0 overflow-hidden">
                                        <span class="block flex-1 min-w-0 truncate">${l.business_name}</span>
                                        ${checkmarkHtml}
                                    </h3>
                                </div>
                            </div>
