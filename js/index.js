...
const CLAIMED_CHECKMARK_SVG = `<svg style="width:18px;height:18px;flex-shrink:0;" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><circle cx="12" cy="12" r="12" fill="#045193"/><path d="M7 12.5l3.5 3.5L17 9" stroke="white" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round"/></svg>`;
                ...
                <div class="flex items-start justify-between mb-3">
                    <div class="flex-1">
                        ...
                        <h3 class="listing-name" style="display:flex;align-items:center;gap:6px;flex-wrap:wrap;">
                            ${escapeHtml(listing.business_name)}${showCheckmark ? CLAIMED_CHECKMARK_SVG : ''}
                        </h3>
